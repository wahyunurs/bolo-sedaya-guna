        ...
        <div class="flex w-full max-w-4xl bg-gray-50 rounded-3xl shadow-lg overflow-hidden h-[560px]">
            ...
            <div class="w-1/2 flex items-center justify-center p-8">
                <div class="relative w-full h-full flex items-center justify-center">
                    ...
                    <div class="relative">
                        <img src="<?php echo e(asset('img/card/auth.png')); ?>" alt="Register Illustration"
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" style="direction: ltr;">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-5">
                        <div class="relative mt-1">
                            ...
                            <input id="nama" name="nama" type="text" value="<?php echo e(old('nama')); ?>" required
...
<?php endif; ?>
                    ...
                    <div class="mb-5">
                        <div class="relative mt-1">
                            ...
                            <input id="alamat" name="alamat" type="text" value="<?php echo e(old('alamat')); ?>" required
                                class="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm"
                                placeholder="Alamat" />
                        </div>
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
...
<?php endif; ?>
                    ...
                    <div class="mb-5">
                        <div class="relative mt-1">
                            ...
                            <input id="nomor_telepon" name="nomor_telepon" type="text" value="<?php echo e(old('nomor_telepon')); ?>"
                                required
                                class="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm"
                        ...
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('nomor_telepon'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('nomor_telepon')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                    ...
                    <div class="text-center mt-6 text-sm text-gray-600">
                        Sudah memiliki Akun? <a href="<?php echo e(route('login')); ?>"
                            class="text-green-600 hover:underline font-medium">Masuk</a>
                    </div>
                </form>
            </div>

            <?php echo app('Illuminate\Foundation\Vite')('resources/js/guest/register.js'); ?>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('auth.components.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Goloka\resources\views/auth/register.blade.php ENDPATH**/ ?>