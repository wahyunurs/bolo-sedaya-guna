...
<section id="kontak" class="py-20 bg-white min-h-screen">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <header class="text-center mb-20 mt-6">
            <h2 class="text-4xl md:text-5xl font-extrabold text-[#40b344] tracking-wide">
            ...
            <div class="p-10 rounded-2xl border border-[#bdbdbd]">
                ...
                <div class="space-y-4 text-gray-800 text-lg">
                    <p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            stroke-linejoin="round" class="w-5 h-5 inline-block mr-2 text-green-800">
                            <path d="M10 22v-6.57" />
                            <path d="M12 11h.01" />
                            <path d="M12 7h.01" />
                            <path d="M14 15.43V22" />
                    ...
                    <p class="flex items-start gap-3 text-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="w-5 h-5 text-green-800">
                            <path
                        ...
                        <span class="ml-1">Dusun Brenggolo, Kecamatan Jatiroto, Kabupaten Wonogiri</span>
                    </p>
                    <p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="w-5 h-5 inline-block mr-2 text-green-800">
                            <path d="m22
                            7-8.991 5.727a2 2 0 0 1-2.009 0L2 7" />
                ...
                <div class="mt-10 flex justify-center">
                    <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer"
                        class="flex items-center justify-center gap-3 bg-[#26a400] hover:bg-[#1f8a00] text-white font-semibold py-3 px-8 rounded-full text-lg shadow-md transition">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-6 h-6" fill="currentColor"
                            aria-hidden="true">
                            <path
