<!-- Product Quick Modal -->
<div id="modalProductQuick" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center z-[999] px-4">
    <div class="bg-white w-full max-w-md p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-xl relative">
        ...
        <div class="flex items-center gap-3 sm:gap-4 mb-4">
            ...
            <img src="{{ asset('img/card/produk1.png') }}" id="modalProductImg"
                class="w-16 h-16 sm:w-20 sm:h-20 rounded-lg object-cover border" alt="Produk">
            <div>
                <p id="modalProductName" class="font-semibold text-green-900 text-base sm:text-lg line-clamp-2">Produk
                </p>
                <p id="modalProductPrice" class="text-gray-600 text-sm sm:text-base">Rp 0</p>
            </div>
        </div>
        ...
        <div class="flex justify-between font-semibold text-green-800 text-base sm:text-lg mb-4">
            <span>Subtotal</span>
            <span id="modalSubtotalText">Rp 0</span>
        </div>

        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center mt-4 sm:mt-6 items-stretch sm:items-center">
            <form id="formTambahKeranjang" method="POST" action="{{ route('user.produk.tambahKeranjang') }}">
                ...
                <button type="submit"
                    ...
                    class="w-full sm:w-auto px-3 sm:px-4 py-2 rounded-lg bg-[#ff7700] hover:bg-[#e66a00] text-white font-semibold text-sm sm:text-base">
                    ...
                    <span>Tambah Keranjang</span></button>
            </form>
            ...
            <form id="formBeliSekarang" method="POST" action="{{ route('user.produk.beliSekarang') }}"
                ...
                <button type="submit"
                    style="display:flex; align-items:center; justify-content:center; gap:6px; white-space:nowrap;"
                    class="w-full sm:w-auto px-3 sm:px-4 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold text-sm sm:text-base">
                    ...
                    <span>Beli Sekarang</span></button>
            </form>
        </div>
    </div>
</div>
