<x-app-layout>
    ...
    <section class="py-16 bg-[#e9ffe1] min-h-screen px-10">

        <!-- Modal Flash Message -->
        @include('user.components.message-modal')


        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 mt-14">
            ...
            <div>
                ...
                <div class="relative mx-auto w-full flex justify-center">
                    <div class="relative rounded-xl overflow-hidden shadow-md w-96 aspect-square">
                        ...
                        <div id="imgNextZone" class="absolute inset-y-0 right-0 w-1/3 cursor-pointer"
                            aria-hidden="true"></div>

                        {{-- Card posisi gambar --}}
                        <div
                            class="absolute top-3 left-3 bg-white px-3 py-1 rounded-lg shadow text-sm font-semibold text-gray-700">
                ...
                {{-- Gambar Thumbnail --}}
                <div class="flex gap-4 mt-4 overflow-x-auto pb-2" id="thumbnailsContainer">
                    @foreach ($produk->gambarProduks as $g)
                        <div data-index="{{ $loop->index }}"
                            class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0 thumbnail-item cursor-pointer {{ $loop->iteration == $posisiGambarUtama ? 'border-2 border-green-500' : 'border border-gray-200' }}">
            ...
            <div class="flex flex-col justify-start">
                ...
                {{-- Judul --}}
                <h1 class="text-3xl md:text-4xl font-extrabold text-green-900 mb-4">
                    {{ $produk->nama }}
                </h1>
                ...
                {{-- Harga --}}
                <p class="text-2xl font-extrabold text-green-700 mb-8">
                ...
                <div class="flex gap-4">
                    ...
                    <button id="openTambahKeranjang" data-price="{{ $produk->harga }}"
                        class="flex items-center gap-2 bg-[#ff7700] text-white px-6 py-3 rounded-xl hover:bg-[#e66a00] transition font-semibold shadow">
                    ...
                    <button id="openBeliSekarang" data-price="{{ $produk->harga }}"
                        class="flex items-center gap-2 bg-[#2fca00] text-white px-6 py-3 rounded-xl hover:bg-[#06b900] transition font-semibold shadow">
