...
<div id="bulkDeleteModal"
    ...
    <div class="bg-white w-[90%] max-w-md p-8 rounded-2xl shadow-xl relative">
        ...
        <p id="bulkDeleteMessage" class="text-sm text-gray-600">
            Anda akan menghapus <span id="bulkDeleteCount" class="font-bold">0</span> item tarif pengiriman. Apakah Anda
...
@vite('resources/js/admin/tarif_pengiriman/konfirmasi-hapus.js')
