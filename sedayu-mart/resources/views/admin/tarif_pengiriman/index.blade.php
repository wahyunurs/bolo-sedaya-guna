<x-app-layout>
    ...
    <main class="ml-0 md:ml-64 peer-checked:md:ml-0 mt-16 transition-all duration-300">
            ...
            <div class="max-w-5xl mx-auto px-6">
                ...
                <div class="mb-6">
                    <nav class="text-sm text-gray-500">
                        <ol class="list-reset flex items-center space-x-2">
                            ...
                            <li class="text-green-700 font-semibold">Tarif Pengiriman</li>
                        </ol>
                        <h1 class="text-3xl font-bold text-gray-800 mt-2">Kelola Tarif Pengiriman</h1>
                    </nav>
                </div>
                ...
                <div class="p-4 rounded-lg bg-white border border-gray-200">
                    <div class="flex items-center justify-between space-x-4 mb-4">
                        <!-- Search form (left) -->
                        <form id="filterForm" method="GET" action="{{ route('admin.tarifPengiriman.index') }}"
                    ...
                    <div class="overflow-x-auto mb-4">
                        <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($tarifPengiriman as $index => $tarif)
                                    <tr class="hover:bg-green-50 hover:shadow-md transition duration-200 ease-in-out">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-700">{{ $tarif->kabupaten }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-700">
                                            {{ 'Rp ' . number_format($tarif->tarif_per_kg, 0, ',', '.') . ',-' }}</td>
                                        <td class="h-full px-6 py-4 text-sm text-gray-700">
                                            <div class="flex items-center justify-center space-x-4 h-full">
                                                ...
                                                <button type="button"
                                                    ...
                                                    aria-label="Edit tarif" data-id="{{ $tarif->id }}"
                                                    data-kabupaten="{{ $tarif->kabupaten }}"
                                                    data-tarif="{{ $tarif->tarif_per_kg }}">
                                                ...
                                                <!-- Tombol Delete -->
                                                <button type="button" data-id="{{ $tarif->id }}"
                                                    data-url="{{ route('admin.tarifPengiriman.destroy', $tarif->id) }}"
        ...
        <!-- Search behavior moved to resources/js/admin/tarif_pengiriman/index.js and loaded via Vite -->
    </main>
    ...
    <!-- Create Tarif Pengiriman Modal -->
    @include('admin.tarif_pengiriman.create-modal')

    <!-- Edit Modal Tarif Pengiriman -->
    @include('admin.tarif_pengiriman.edit-modal')

    <!-- Create Modal Tarif Pengiriman -->
    @include('admin.tarif_pengiriman.create-modal')

    <!-- Konfirmasi Hapus Modal -->
    @include('admin.tarif_pengiriman.konfirmasi-hapus')

    <!-- Tarif Pengiriman JavaScript -->
    @vite('resources/js/admin/tarif_pengiriman/index.js')
