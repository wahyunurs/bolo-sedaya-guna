<!-- Add Varian Modal -->
<div id="add-varian-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] flex flex-col">
            ...
            <div
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-blue-100 uppercase tracking-wider mb-1">Tambah Varian
                            </p>
                            <h3 class="text-xl md:text-2xl font-bold text-white leading-tight">Varian Baru</h3>
                        </div>
                    </div>
                    <button type="button"
                        ...
                        data-modal-hide="add-varian-modal">
            ...
            <form action="{{ route('admin.produk.varian.store', $produk->id) }}" method="POST"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Upload gambar (max 5MB)</p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-4 items-start">
                            ...
                            <div class="flex-shrink-0">
                                <div id="image-preview-varian" class="hidden">
                                    <img id="preview-img-varian" src="" alt="Preview"
                                        class="w-40 h-40 object-cover rounded-xl shadow-md border-2 border-gray-200">
                                </div>
                                <div id="no-preview-varian"
                            ...
                            <div class="flex-1">
                                <div
                                    ...
                                    <input type="file" id="gambar" name="gambar" accept="image/*"
                                        ...
                                        onchange="previewImageVarian(event)" required>
                                ...
                                <p class="mt-2 text-xs text-gray-500" id="file-name-varian"></p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <button type="button" data-modal-hide="add-varian-modal"
...
<script>
    function previewImageVarian(event) {
        const input = event.target;
        const preview = document.getElementById('preview-img-varian');
        const imagePreview = document.getElementById('image-preview-varian');
        const noPreview = document.getElementById('no-preview-varian');
        const fileName = document.getElementById('file-name-varian');
