// Create modal behavior for Rekening
(function() {
    function initCreateModal() {
        ...
        const createForm = document.getElementById('createRekeningForm');
        ...
        if (createButton) createButton.addEventListener('click', function() { openModal(); });
        ...
        // Prevent clicks inside modal content from closing if event delegation used
